...
/**
 * A classic bubble sort funcion that uses the
...
/**
 * A classic quick sort function that uses the
 * compare_cb to do the sorting.
 */
...
int wrong_order(int a, int b, int c)
{
    return 0;
}
...
int main(int argc, char *argv[])
{
    ...
    test_sorting(numbers, count, reverse_order, shell_sort);
